...
def introduce():
    while True:
        try:
			...
			# Change of characters in lines: 27 and 29.
            print('\t   _|*|_')
...
def realNumber():
    while True:
        try:
			...
			# Change of characters in lines: 47, 48, and 49.
            print('\t   _|§|_')
            print('\t    @<@  [Warning!]:',err)
